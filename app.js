document.addEventListener('DOMContentLoaded', () => {
    ...
    function getCharacterObject(name, list) {
        ...
        return { name: name, tags: ["unknown"] }; // Fallback
    }
    ...
    // --- LOCAL STORAGE & WORKSPACE FUNCTIONS ---
    function saveLegend() {
        ...
        const legendToSave = { 
            ...
            id: Date.now(),
            // Save the editable workspace content
    ...
    function loadLegend(id) {
        ...
        // Load the core idea
        currentSelection = {
            protagonist: getCharacterObject(legend.protagonist.name || legend.protagonist, data.protagonists),
            antagonist: getCharacterObject(legend.antagonist.name || legend.antagonist, data.antagonists),
        ...
        // Update UI dropdowns to reflect loaded selection
        ...
        displayCurrentLegend();
        updateAllOutputs(); // Regenerate non-editable content like art prompt

        // Populate workspace with saved edits
